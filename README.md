...
**第1-20輪（初期訓練）**
- 模型快速收斂，mAP50 從 55.9% 提升至 93.0%
- 第13輪達到首次高峰（mAP50: 94.3%, mAP50-95: 64.8%）
- 訓練損失持續下降，顯示良好的學習效果

**第21-50輪（穩定期）**
- mAP50 穩定在 93-96% 之間
- mAP50-95 持續提升至 70%+ 水準
- 第46-49輪表現優異（mAP50: 96.3-96.9%）
...
✅ **高準確率**：mAP50 達到 96.7%，顯示模型對主動脈瓣膜的定位非常精確  
✅ **良好泛化**：訓練與驗證損失同步下降，無過擬合跡象  
✅ **穩定性佳**：最後50個epoch保持穩定高性能  
✅ **平衡表現**：Precision 和 Recall 均達 91%+，檢測平衡性優異  
✅ **精確定位**：mAP50-95 達到 70.9%，IoU 閾值提高仍保持高準確率
